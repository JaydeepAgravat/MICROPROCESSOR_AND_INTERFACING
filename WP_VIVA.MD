...
17. Q: What is the purpose of the "target" attribute in the <a> element?
    A: The "target" attribute in the <a

> element is used to specify where the linked document should be displayed, such as in a new window or tab.
...
19. Q: What is the difference between "em" and "
...
17. Q: What is JSON in JavaScript?
    A: JSON (JavaScript Object Notation) is a lightweight data interchange format that is used

 for storing and exchanging data between a browser and a server. It is based on a subset of JavaScript object syntax.
...
18. Q: How do you handle cookies in PHP?
 ...
 can be managed using the $_COOKIE superglobal array, which allows reading, setting, and deleting cookie values.
